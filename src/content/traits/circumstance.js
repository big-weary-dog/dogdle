...
export const CIRCUMSTANCE = [
  ...
  { text: "Has a restraining order", emoji: "⛔", value: -5, category: "circumstance",
    effect: { type: "vignette", layer: "front", params: { color: "#450a0a", opacity: 0.55 } } },

  { text: "Owner is getting divorced", emoji: "💔", value: -5, category: "circumstance",
  ...
  { text: "Won something in 2019", emoji: "🏆", value: 2, category: "circumstance",
    effect: { type: "burst", layer: "front", params: { color: "#fbbf24", count: 30, spread: 150, confetti: true } } },
  { text: "Has never seen grass", emoji: "🏢", value: -5, category: "circumstance",
    effect: { type: "drain", layer: "subject", params: { amount: 0.6 } } },
  { text: "Has a nemesis", emoji: "😾", value: -4, category: "circumstance", effect: null },
  { text: "Has been to Paris", emoji: "🗼", value: 3, category: "circumstance",
    effect: { type: "rays", layer: "back", params: { color: "#fcd34d", beams: 8, opacity: 0.26, speed: 0.09 } } },
  { text: "Is the reason for the no-dogs rule", emoji: "🚷", value: -5, category: "circumstance",
    effect: { type: "glitch", layer: "front", params: { color: "#fb923c", intensity: 0.4, scanlines: false } } },
  { text: "Appears in a stranger's wedding photos", emoji: "💒", value: 2, category: "circumstance",
  ...
  { text: "First time homeowner", emoji: "🏡", value: 2, category: "circumstance",
  ...
  { text: "Rick and Morty superfan", emoji: "🛸", value: -5, category: "circumstance",
  ...
  { text: "Banned from one (1) country", emoji: "🚨", value: -5, category: "circumstance",
  ...
  { text: "Birthday today", emoji: "🎂", value: 3, category: "circumstance",
    effect: { type: "burst", layer: "front", params: { color: "#f472b6", count: 30, spread: 150, confetti: true } } },
  { text: "Raised by ducks", emoji: "🦆", value: 2, category: "circumstance",
    effect: { type: "fall", layer: "front", params: { color: "#fef9c3", shape: "petal", count: 16, speed: 0.6, sway: 2, size: 4 } } },
  { text: "Best friends with a horse", emoji: "🐴", value: 2, category: "circumstance", effect: null },
  { text: "Owes a crow money", emoji: "🐦", value: -3, category: "circumstance", effect: null },
  { text: "Tried to eat a hedgehog. Lost.", emoji: "🦔", value: -3, category: "circumstance", effect: null },
  { text: "One specific squirrel", emoji: "🐿️", value: -1, category: "circumstance", effect: null },
  { text: "Beat the robot vacuum in single combat", emoji: "🤖", value: 2, category: "circumstance", effect: null },
  { text: "Butt-dialled 911", emoji: "📞", value: -3, category: "circumstance",
    effect: { type: "pulse", layer: "back", params: { color: "#ef4444", period: 900, radius: 160 } } },
  { text: "Alexa takes his orders. Forty tennis balls so far.", emoji: "🔊", value: -4, category: "circumstance",
    effect: { type: "ripple", layer: "back", params: { color: "#22d3ee", rings: 3, speed: 1, maxRadius: 150 } } },
  { text: "Sponsored by a treat brand", emoji: "💸", value: 4, category: "circumstance", group: "money",
    effect: { type: "spotlight", layer: "front", params: { color: "#fde68a", radius: 110, speed: 0.8 } } },
  { text: "Paintings sell for $400", emoji: "🎨", value: 3, category: "circumstance", effect: null },
  { text: "Has an agent. No bookings.", emoji: "🎭", value: -1, category: "circumstance", effect: null },
  { text: "Ate a library book. Chapter seven specifically.", emoji: "📚", value: -3, category: "circumstance",
    effect: { type: "fall", layer: "front", params: { color: "#f5f5f4", shape: "square", count: 18, speed: 0.9, sway: 1.4, size: 5 } } },
  { text: "Reincarnated from your grandmother", emoji: "♾️", value: 3, category: "circumstance",
    effect: { type: "halo", layer: "subject", params: { color: "#e9d5ff", size: 12 } } },
  { text: "Has a girlfriend across the street", emoji: "💌", value: 2, category: "circumstance",
    effect: { type: "rise", layer: "front", params: { color: "#f472b6", shape: "heart", count: 12, speed: 0.7, sway: 1.5, size: 10 } } },
  { text: "Dumped by a poodle", emoji: "💔", value: -3, category: "circumstance",
    effect: { type: "fall", layer: "front", params: { color: "#93c5fd", shape: "line", count: 30, speed: 2, sway: 0, size: 8 } } },
  { text: "Invited to every birthday party", emoji: "🎉", value: 2, category: "circumstance",
    effect: { type: "burst", layer: "front", params: { color: "#60a5fa", count: 26, spread: 140, confetti: true } } },
  { text: "Uninvited from Thanksgiving", emoji: "🦃", value: -4, category: "circumstance", effect: null },
  { text: "Pulled a child from a lake", emoji: "🛟", value: 7, category: "circumstance",
    effect: { type: "rays", layer: "back", params: { color: "#fef08a", beams: 10, opacity: 0.3, speed: 0.07 } } },
  { text: "Found a gas leak", emoji: "🧯", value: 3, category: "circumstance", effect: null },
  { text: "Retired airport drug dog. Knows things.", emoji: "🛃", value: 3, category: "circumstance", group: "job",
    effect: { type: "spotlight", layer: "front", params: { color: "#e5e7eb", radius: 100, speed: 1 } } },
  { text: "Dishonourably discharged from the K-9 unit", emoji: "🪖", value: -4, category: "circumstance", group: "job",
    effect: { type: "drain", layer: "subject", params: { amount: 0.5 } } },
  { text: "Guarded a grave for fourteen years. Wrong grave.", emoji: "🪦", value: -1, category: "circumstance",
    effect: { type: "fog", layer: "front", params: { color: "#94a3b8", bands: 2, opacity: 0.3, speed: 0.4 } } },
  { text: "Bit an elephant on the lip. For you.", emoji: "🐘", value: 5, category: "circumstance", effect: null },
  { text: "Won a trial by combat", emoji: "⚔️", value: 6, category: "circumstance",
    effect: { type: "burst", layer: "front", params: { color: "#e5e7eb", count: 18, spread: 120 } } },
  { text: "Walked 2,500 miles home. You'd moved.", emoji: "🗺️", value: -3, category: "circumstance",
    effect: { type: "tint", layer: "subject", params: { sepia: 0.5, hue: 0, saturate: 0.9 } } },
  { text: "Has a statue somewhere", emoji: "🏛️", value: 4, category: "circumstance", group: "fame", effect: null },
  { text: "Former witch's familiar. Took early retirement.", emoji: "🧹", value: 1, category: "circumstance",
    effect: { type: "rise", layer: "front", params: { color: "#a78bfa", count: 12, speed: 0.6, sway: 1.8, size: 3, glow: true } } },
  { text: "Has his own constellation", emoji: "🌌", value: 6, category: "circumstance",
    effect: { type: "stars", layer: "back", params: { color: "#ffffff", count: 70, twinkle: 0.6 } } },
  { text: "Followed a stranger home. They're lucky now.", emoji: "🐾", value: 2, category: "circumstance", effect: null },
  { text: "Anti-poaching paratrooper", emoji: "🪂", value: 6, category: "circumstance", group: "job", effect: null },
];

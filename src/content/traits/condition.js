...
export const CONDITION = [
  ...
  { text: "Wearing a small hat", emoji: "🎩", value: 2, category: "condition", effect: null },
  ...
  { text: "Groomed this morning", emoji: "💈", value: 2, category: "condition",
    effect: { type: "halo", layer: "subject", params: { color: "#ffffff", size: 10, brightness: 1.15 } } },
  ...
  { text: "Wearing a sweater someone knitted", emoji: "🧶", value: 2, category: "condition",
  ...
  { text: "Surrounded by bees", emoji: "🐝", value: -5, category: "condition", effect: null },
  ...
  { text: "Glows faintly. Unexplained.", emoji: "🔮", value: 3, category: "condition",
  ...
  { text: "Statistically the luckiest dog alive", emoji: "🍀", value: 4, category: "condition",
  ...
  { text: "Appears in two places at once", emoji: "🌀", value: 4, category: "condition",
  ...
  { text: "Great-great-grandson of Freud's dog", emoji: "🛋️", value: 3, category: "condition", group: "pedigree",
    effect: { type: "vignette", layer: "front", params: { color: "#3f2a1d", opacity: 0.4 } } },
  { text: "Seeing him is an omen of death", emoji: "🖤", value: -5, category: "condition", group: "omen",
    effect: { type: "vignette", layer: "front", params: { color: "#000000", opacity: 0.6 } } },
  { text: "Seeing him before 9am is good luck", emoji: "🌅", value: 4, category: "condition", group: "omen",
    effect: { type: "rays", layer: "back", params: { color: "#fde68a", beams: 8, opacity: 0.25, speed: 0.05 } } },
  { text: "Feed him on New Year's Eve for a prosperous year", emoji: "🎆", value: 3, category: "condition", group: "omen",
    effect: { type: "burst", layer: "front", params: { color: "#fbbf24", count: 28, spread: 150, confetti: true } } },
  { text: "Tallest dog in the county", emoji: "🦒", value: 2, category: "condition", group: "build", effect: null },
  { text: "Tail longer than the rest of him", emoji: "📏", value: -1, category: "condition", group: "tail", effect: null },
];

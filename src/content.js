...
export const MODIFIERS = [
  ...
  { text: "Worms", emoji: "🪱", value: -3, category: "health",
  ...
  { text: "Vet says he's fine. He is not fine.", emoji: "🩺", value: -3, category: "health",
  ...
  { text: "Rehomed twice", emoji: "📦", value: -3, category: "circumstance", effect: null },
  ...
  { text: "Four owners deep", emoji: "🔁", value: -3, category: "circumstance",
  ...
  { text: "Chases his tail for hours", emoji: "🌀", value: -3, category: "habit",
  ...
  { text: "Cone of shame", emoji: "🔺", value: -3, category: "condition",
  ...
  { text: "Surrounded by bees", emoji: "🐝", value: -3, category: "condition", effect: null },
  ...
  { text: "Cannot be photographed properly", emoji: "📵", value: -3, category: "condition",
  ...
  { text: "Outlived two previous owners", emoji: "🕰️", value: -2, category: "circumstance",
  ...
  { text: "Experimental test subject", emoji: "🧪", value: -5, category: "health",
    effect: { type: "chromatic", layer: "subject", params: { offset: 3 } } },
  { text: "Gambling addiction", emoji: "🎰", value: -4, category: "habit",
    effect: { type: "burst", layer: "front", params: { color: "#fbbf24", count: 30, spread: 150, confetti: true } } },
  ...
  { text: "Megacorporation CEO", emoji: "💼", value: 6, category: "circumstance",
    effect: { type: "rays", layer: "back", params: { color: "#fcd34d", beams: 8, opacity: 0.3, speed: 0.08 } } },
  { text: "Supreme Court Justice", emoji: "⚖️", value: 7, category: "circumstance",
    effect: { type: "spotlight", layer: "front", params: { color: "#fef3c7", radius: 140, speed: 0.3 } } },
  ...
  { text: "Always drunk", emoji: "🍺", value: -3, category: "habit",
  ...
  { text: "Dogdle developer", emoji: "👨‍💻", value: 5, category: "circumstance",
...
export const QUALITY_TIERS = [
  { max: -17, label: "Genuinely Concerning", color: "#f87171" },
  { max: -10, label: "Rough", color: "#fb923c" },
  { max: 6, label: "A Dog", color: "#facc15" },
  { max: 14, label: "Good Dog", color: "#4ade80" },

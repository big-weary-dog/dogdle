...
export const MODIFIERS = [
  ...
  { text: "Sleeps through the night", emoji: "😴", value: 3, category: "temperament", effect: null },
  { text: "Good with kids", emoji: "🧒", value: 2, category: "temperament",
  ...
  { text: "Lives in a studio apartment", emoji: "🏢", value: -2, category: "circumstance", effect: null },
  ...
  { text: "Inherited, along with the house", emoji: "🏚️", value: 1, category: "circumstance", effect: null },
  ...
  { text: "Waits by the door all day", emoji: "🚪", value: 1, category: "habit", effect: null },
  { text: "Never once had an accident indoors", emoji: "✨", value: 3, category: "habit", effect: null },
...
export const QUALITY_TIERS = [
  { max: -19, label: "Genuinely Concerning", color: "#f87171" },
  { max: -12, label: "Rough", color: "#fb923c" },
  { max: 2, label: "A Dog", color: "#facc15" },

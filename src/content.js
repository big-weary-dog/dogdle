...
export const QUALITY_TIERS = [
  { max: -25, label: "Should Not Have Happened", color: "#dc2626" },
  { max: -16, label: "Genuinely Concerning", color: "#f87171" },
  { max: -9, label: "Rough", color: "#fb923c" },
  { max: -3, label: "Below Average", color: "#fbbf24" },
  { max: 2, label: "Perfectly Average", color: "#facc15" },
  { max: 8, label: "Above Average", color: "#a3e635" },
  { max: 15, label: "Good Dog", color: "#4ade80" },
  { max: 24, label: "Exceptional Animal", color: "#22d3ee" },
  { max: Infinity, label: "Platonic Ideal of Dog", color: "#a78bfa" },
];
